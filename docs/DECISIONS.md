...
SIGNATURE` for two days after the signature it sat directly above; corrected 2026-09-14 in the same PR as this
note. `charterHash` is computed over the canonical JSON of the *parsed* charter, so no comment edit can alter
...
**Still formally open, though the code is live (noted 2026-09-14).** The acceptance mechanism above assumed the
